...
// let transpoter = nodemailer.createTestAccount({
//   host: "smdp.sendgrid.net",
//   port: 587,
//   auth: {
//     user: "apikey",
...
const transpoter = nodemailer.createTransport(mg(auth));
...
async function run() {
  try {
    ...
    const sendPaymentConfirmationEmail = (payment) => {
      transpoter.sendMail(
        {
          from: "sikder89098@gmail.com",
          to: "sikder89098@gmail.com",
